...
//    RCC_AHB1PeriphClockCmd(OV7670_Periph, ENABLE);
//    
//    GPIO_InitStructure.GPIO_Pin = OV7670_PWDN_Pin|OV7670_RST_Pin;
//    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
//    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
//    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;
//    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;
//    GPIO_Init(OV7670_GPIO, &GPIO_InitStructure);
//    
//    OV7670_PWDN=0;	//POWER ON
//	delay_ms(10);
//	OV7670_RST=0;	//复位OV2640
//	delay_ms(10);
//	OV7670_RST=1;	//结束复位
